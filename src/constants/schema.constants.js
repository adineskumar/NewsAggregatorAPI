...
const ERR_PREFERENCES = "The 'preferences' field must be according to the preferences schema.";
...
// Common
const ERR_ADDITIONAL_PROPERTIES = "The input should not have additional properties.";
